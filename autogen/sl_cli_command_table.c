...
void emberAfPluginCountersClearCommand(sl_cli_command_arg_t *arguments);
...
void emberAfPluginCountersResetThresholdsCommand(sl_cli_command_arg_t *arguments);
...
void emberAfPluginNetworkCreatorStopCommand(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd_counters_clear = \
  SL_CLI_COMMAND(emberAfPluginCountersClearCommand,
...
static const sl_cli_command_info_t cli_cmd_counters_reset_hyphen_thresholds = \
  SL_CLI_COMMAND(emberAfPluginCountersResetThresholdsCommand,
...
static const sl_cli_command_info_t cli_cmd_network_hyphen_creator_stop = \
  SL_CLI_COMMAND(emberAfPluginNetworkCreatorStopCommand,
...
static const sl_cli_command_info_t cli_cmd_print_attr = \
  SL_CLI_COMMAND(printAttributeTableCommand,
                 "Prints attribute.",
                  "",
                 {SL_CLI_ARG_END, });
